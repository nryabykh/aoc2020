...
class DayOneTestSpec extends FlatSpec {
  ...
  "Day One challenge" should "return correct result on sample data" in {
    val input = """1721
    979
    366
    299
  ...
  "Day One challenge" should "find three numbers sumed to 2020 on sample data" in {
    val input = """1721
    979
    366
    299
  ...
  "Day One challenge" should "calculate result on test sample" in {
    val input = """1834
                  |1546
                  |1119
                  |1870
  ...
  "Day One challenge" should "find three numbers sumed to 2020 on test data" in {
    val input = """1834
                  |1546
                  |1119
                  |1870
