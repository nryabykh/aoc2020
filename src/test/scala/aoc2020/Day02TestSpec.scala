...
class Day02TestSpec extends AoCTest {
  ...
  private val testInput = """1-4 m: mrfmmbjxr
                ...
                |3-7 g: gdgtnfggq""".stripMargin

  "Simple password checker" should "return 2 correct passwords on sample data" in {
    val calc = new Day02PasswordPhilosophy(sampleInput.split("\n").toList, "simple",true)
    calc.cnt should be (2)
  }

  it should "calculate correct passwords on test data" in {

    val calc = new Day02PasswordPhilosophy(testInput.split("\n").toList, "simple")
    println(calc.cnt)
    calc.cnt should be (607)
  }

  "Tricky password checker" should "return 1 correct passwords on sample data" in {

    val calc = new Day02PasswordPhilosophy(sampleInput.split("\n").toList, "tricky",true)
    calc.cnt should be (1)
  }

  it should "calculate correct passwords on test data" in {
    val calc = new Day02PasswordPhilosophy(testInput.split("\n").toList, "tricky")
    println(calc.cnt)
    calc.cnt should be (321)
  }
}
