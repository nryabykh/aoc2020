...
class Day04TestSpec extends AoCTest {
  override def sampleInput: String = """ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
  ...
  override def testInput: String = """ecl:hzl byr:1926 iyr:2010
                                     ...
                                     |byr:2000
                                     |ecl:hzl eyr:2029
                                     |iyr:2011 hcl:#866857 hgt:74in""".stripMargin

  "Passport Processor" should "return 2 correct passports on sample data" in {
    val requiredFields = List("byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid")
    val optionalFields = List("cid")
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.getCorrect(requiredFields, optionalFields) should be (2)
  }

  it should "calculate result on test data" in {
    val requiredFields = List("byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid")
    val optionalFields = List("cid")
    val calculator = new Day04PassportProcessor(testInput, debug = false)
    calculator.getCorrect(requiredFields, optionalFields) should be (237)
  }

  it should "check correctly if BYR is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isByrCorrect("1910") should be (false)
    calculator.isByrCorrect("1985") should be (true)
    calculator.isByrCorrect("2015") should be (false)
    calculator.isByrCorrect("text") should be (false)
  }

  it should "check correctly if IYR is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isIyrCorrect("2000") should be (false)
    calculator.isIyrCorrect("2015") should be (true)
    calculator.isIyrCorrect("2021") should be (false)
    calculator.isIyrCorrect("text") should be (false)
  }

  it should "check correctly if EYR is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isEyrCorrect("2015") should be (false)
    calculator.isEyrCorrect("2021") should be (true)
    calculator.isEyrCorrect("2031") should be (false)
    calculator.isEyrCorrect("text") should be (false)
  }

  it should "check correctly if height is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isHgtCorrect("90cm") should be (false)
    calculator.isHgtCorrect("180cm") should be (true)
    calculator.isHgtCorrect("1800cm") should be (false)
    calculator.isHgtCorrect("textcm") should be (false)
    calculator.isHgtCorrect("9in") should be (false)
    calculator.isHgtCorrect("70in") should be (true)
    calculator.isHgtCorrect("700in") should be (false)
    calculator.isHgtCorrect("textin") should be (false)
    calculator.isHgtCorrect("text") should be (false)
    calculator.isHgtCorrect("70") should be (false)
    calculator.isHgtCorrect("150") should be (false)
  }

  it should "check correctly if hair color is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isHclCorrect("#a0f8bb") should be (true)
    calculator.isHclCorrect("#-0f8bb") should be (false)
    calculator.isHclCorrect("#a0f8zb") should be (false)
    calculator.isHclCorrect("a0f8bb") should be (false)
  }

  it should "check correctly if eye color is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isEclCorrect("amb") should be (true)
    calculator.isEclCorrect("blu") should be (true)
    calculator.isEclCorrect("test") should be (false)
  }

  it should "check correctly if pid is valid or not" in {
    val calculator = new Day04PassportProcessor(sampleInput, debug = false)
    calculator.isPidCorrect("000000001") should be (true)
    calculator.isPidCorrect("0123456789") should be (false)
    calculator.isPidCorrect("abcabcabc") should be (false)
  }

  it should "return 0 correct passports with additional rules on invalid data" in {
    ...
    val requiredFields = List("byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid")
    val optionalFields = List("cid")
    val calculator = new Day04PassportProcessor(data, debug = false)
    calculator.getCorrectWithRules(requiredFields, optionalFields) should be (0)
  }

  it should "return 4 correct passports with additional rules on valid data" in {
    ...
    val optionalFields = List("cid")
    val calculator = new Day04PassportProcessor(data, debug = false)
    calculator.getCorrectWithRules(requiredFields, optionalFields) should be (4)
  }

  it should "calculate result with additional rules on test data" in {
    val requiredFields = List("byr", "iyr", "eyr", "hgt", "hcl", "ecl", "pid")
    val optionalFields = List("cid")
    val calculator = new Day04PassportProcessor(testInput, debug = false)
    calculator.getCorrectWithRules(requiredFields, optionalFields) should be (172)
  }
}
